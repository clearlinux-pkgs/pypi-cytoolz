...
Source0  : https://files.pythonhosted.org/packages/c1/75/e2e5cbe5309f14265d6c9ac543933a24b168416f87ae9275083be10759eb/cytoolz-0.12.0.tar.gz
...
%prep
%setup -q -n cytoolz-0.12.0
cd %{_builddir}/cytoolz-0.12.0
pushd ..
cp -a cytoolz-0.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657552537
...
cp %{_builddir}/cytoolz-0.12.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-cytoolz/84a923202781778b1726c702c36c25eb8660e50b
