...
Source0  : https://files.pythonhosted.org/packages/70/d8/8df71050b214686591241a1826d2e6934b5c295c5bc57f643e4ed697f1eb/cytoolz-0.12.3.tar.gz
...
%prep
%setup -q -n cytoolz-0.12.3
cd %{_builddir}/cytoolz-0.12.3
pushd ..
cp -a cytoolz-0.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706200543
