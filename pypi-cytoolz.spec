...
Source0  : https://files.pythonhosted.org/packages/a7/f9/3243eed3a6545c2a33a21f74f655e3fcb5d2192613cd3db81a93369eb339/cytoolz-1.0.1.tar.gz
...
%prep
%setup -q -n cytoolz-1.0.1
cd %{_builddir}/cytoolz-1.0.1
pushd ..
cp -a cytoolz-1.0.1 buildavx2
popd
pushd ..
cp -a cytoolz-1.0.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735094681
